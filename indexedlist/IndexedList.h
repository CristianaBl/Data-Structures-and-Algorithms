...
struct DLLNode {
    TElem data;
    DLLNode* prev;//pointer previous node
    DLLNode* next;//pointer next node

};
class IndexedList {
private:
    DLLNode* head;//primul nod
    DLLNode* tail;//ultimul nod lista
    int length;
	//DO NOT CHANGE THIS PART
...
public:
    ...
    void addAll(const IndexedList& otherList);
